...
class PokerHandTest {
    ...
    public void straightFlushTest() {
        ...
        assertThat(sf_a2345_h.ties(sf_2345a_s)).isTrue();
    ...
    public void quadsTest() {
        ...
        assertThat(quads_jq.ties(quads_jq_alt)).isTrue();
        assertThat(quads_jq_alt.ties(quads_jq)).isTrue();
    ...
    public void fullHouseTest() {
        ...
        assertThat(fh_a2.ties(fh_a2_alt)).isTrue();
        assertThat(fh_a2_alt.ties(fh_a2)).isTrue();
    ...
    public void flushTest() {
        ...
        assertThat(flush_aqkj9_h.ties(flush_aqkj9_h)).isTrue();
        assertThat(flush_3k49j_d.ties(flush_3k49j_s)).isTrue();
    ...
    public void straightTest() {
        ...
        assertThat(straight_jqkta.ties(straight_jqkta_alt)).isTrue();
        assertThat(straight_jqkta_alt.ties(straight_jqkta)).isTrue();
    ...
    public void tripsTest() {
        ...
        assertThat(trips_73q.ties(trips_7q3)).isTrue();
    ...
    public void twoPairsTest() {
        ...
        assertThat(tp_a76.ties(tp_7a6)).isTrue();
    ...
    public void pairTest() {
        ...
        assertThat(p_2k39.ties(p_239k)).isTrue();
    ...
    public void highCardTest() {
        ...
        assertThat(hc_aj542.ties(hc_245ja)).isTrue();
